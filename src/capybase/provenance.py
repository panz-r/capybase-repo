...
PROVENANCE_LABELS: dict[str, str] = {
    ...
    "deterministic_symbol_injection": "deterministic symbol injection (C1)",
    "deterministic_use_dedup": "deterministic use-statement dedup (R2)",
    "deterministic_source_current_only": "source portfolio (current only)",
    "deterministic_source_replayed_only": "source portfolio (replayed only)",
    "deterministic_source_cur_rep": "source portfolio (current + replayed)",
    "deterministic_source_rep_cur": "source portfolio (replayed + current)",
    "deterministic_source_shared": "source portfolio (shared + distinct)",
    "deterministic_source_union": "source portfolio (git union merge)",
